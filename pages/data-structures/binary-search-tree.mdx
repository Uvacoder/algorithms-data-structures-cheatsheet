...
The time complexity of operations is directly proportional to the height of the tree. It allows for binary search, which has a fast search, insertion and deletion of items. On average, the search, insertion and deletion operations take O(log n).
