...
This uses JavaScript's Map object for the hash table. You can refer to [hash table example](https://dsa-cheatsheet.vercel.app/data-structures/hash-table) to get an idea of how a simple hash table works under the hood.
