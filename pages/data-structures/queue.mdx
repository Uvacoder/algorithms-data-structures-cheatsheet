...
2. enqueue(item) - pushes an item to the end of the queue.
...
You can refer to [linked list](https://dsa-cheatsheet.vercel.app/data-structures/linked-list) to get an idea of how a linked list works.
